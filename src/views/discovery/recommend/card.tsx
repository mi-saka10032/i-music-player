...
const Card = memo(({ info, getPlaylists }: CardProps) => {
  ...
  return (
    <div className="relative box-content w-full pt-[100%] cursor-pointer group" onClick={getPlaylists.bind(null, info.id, false)}>
      <div className="absolute w-full pt-[100%] top-0 left-0">
        ...
        <div
          ...
          onClick={getPlaylists.bind(null, info.id, true)}
        >
